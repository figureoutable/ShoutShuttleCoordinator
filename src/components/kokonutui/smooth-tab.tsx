...
interface SmoothTabProps {
  ...
  /** Stacked puts tabs above full-width content (better for dense operational views). */
...
export default function SmoothTab({
  ...
  const tabBar = (
    <div
      ...
      className={cn(
        "no-print relative mt-auto flex items-center justify-between gap-1 py-1",
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="relative mb-4 flex-1">
        <div className="relative min-h-[420px] w-full rounded-lg border bg-card lg:min-h-[520px]">
