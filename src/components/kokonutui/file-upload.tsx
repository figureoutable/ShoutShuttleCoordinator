...
const UploadIllustration = () => (
  <div className="relative h-16 w-16">
    ...
    >
      ...
      <path
        className="fill-[#FCE8E7] stroke-[#EF6C64] dark:fill-rose-950/30 dark:stroke-[#F5A09A]"
      ...
      <path
        className="stroke-[#EF6C64] dark:stroke-[#F5A09A]"
  ...
  return (
    ...
    >
      <div className="group relative w-full rounded-xl bg-white p-0.5 ring-1 ring-gray-200 dark:bg-black dark:ring-white/10">
        <div className="absolute inset-x-0 -top-px h-px w-full bg-gradient-to-r from-transparent via-[#EF6C64]/20 to-transparent" />
        ...
        <div className="relative w-full rounded-[10px] bg-gray-50/50 p-1.5 dark:bg-white/[0.02]">
          ...
          >
            ...
            >
              <div className="absolute inset-x-0 top-0 h-[20%] bg-gradient-to-b from-[#EF6C64]/10 to-transparent" />
              <div className="absolute inset-x-0 bottom-0 h-[20%] bg-gradient-to-t from-[#EF6C64]/10 to-transparent" />
              <div className="absolute inset-y-0 left-0 w-[20%] bg-gradient-to-r from-[#EF6C64]/10 to-transparent" />
              <div className="absolute inset-y-0 right-0 w-[20%] bg-gradient-to-l from-[#EF6C64]/10 to-transparent" />
              <div className="absolute inset-[20%] animate-pulse rounded-lg bg-[#EF6C64]/5 transition-all duration-300" />
            </div>

            <div className="absolute -top-4 -right-4 h-8 w-8 bg-gradient-to-br from-[#EF6C64]/20 to-transparent opacity-0 blur-md transition-opacity duration-500 group-hover:opacity-100" />
                  ...
                  >
                    ...
                    <div className="mb-4 space-y-1.5 text-center">
                      ...
                      <div className="flex items-center justify-center gap-2 text-xs">
                        ...
                        <span className="font-medium text-[#EF6C64]">
                          {Math.round(progress)}%
                        </span>
                      </div>
                    </div>
